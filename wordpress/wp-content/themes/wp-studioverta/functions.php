...
function wpeHeadNav()
{
    ...
    array(
        ...
        'link_before'     => '',
        'link_after'      => '',
        'items_wrap'      => '<ul class="h-menu">%3$s</ul>',
        'depth'           => 0,
        'walker'          => ''
        )
    );
}
function wpeSubHeadNav()
{
	wp_nav_menu(
	array(
...
function wpeFootNav() {
    ...
    array(
        ...
        'link_before'     => '',
        'link_after'      => '',
        'items_wrap'      => '<ul class="f-menu">%3$s</ul>',
        'depth'           => 0,
        'walker'          => ''
        )
    );
...
// WPE footer navigation
function wpeFootTwoNav() {
	wp_nav_menu(
	array(
		'theme_location'  => 'footer-double-menu',
		'menu'            => '', 
		'container'       => 'div', 
		'container_class' => 'menu-{menu slug}-container', 
		'container_id'    => '',
...
// WPE sidebar navigation
function wpeSideDobNav() {
	wp_nav_menu(
	array(
		'theme_location'  => 'sidebar-dob-menu',
		'menu'            => '', 
		'container'       => 'div', 
		'container_class' => 'menu-{menu slug}-container', 
		'container_id'    => '',
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul class="sidemenu">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function register_html5_menu() {
    register_nav_menus(array( 
        'header-menu' => __('Меню #1 шапке', 'wpeasy'), 
        'header-sub-menu' => __('Меню #2 шапке', 'wpeasy'), 
        'sidebar-dob-menu' => __('Меню в сайдбар', 'wpeasy'), 
        'sidebar-menu' => __('Меню в подвал #1', 'wpeasy'), 
        'footer-menu' => __('Меню в подвал #2', 'wpeasy'), 
        'footer-double-menu' => __('Меню в подвал #2', 'wpeasy') 
    ));
}
...
if (function_exists('register_sidebar')) {
    ...
    register_sidebar(array(
        'name' => __('Подвал #1', 'wpeasy'),
        'description' => __('Не больше 1 виджета!!!', 'wpeasy'),
        'id' => 'widgetareaf1',
        'before_widget' => '<div id="%1$s" class="f-block %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
    ));
    register_sidebar(array(
        'name' => __('Подвал #2', 'wpeasy'),
        'description' => __('Не больше 1 виджета!!!', 'wpeasy'),
        'id' => 'widgetareaf2',
        'before_widget' => '<div id="%1$s" class="f-block %2$s">',
        'after_widget' => '</div>',
